        ...
        <div className="md:flex md:min-h-screen">
            ...
            <main className="flex-1">
                ...
                <form className="border-solid border border-black my-10 bg-white shadow rounded-lg p-10" onSubmit={onSubmit}>
                    <div className="my-5">
                        <label className="uppercase text-black block text-lx font-bold">Nombre de Categoria</label>
                        <input 
                            type="nombre"
                            id="nombre"
                            name="nombre"
                            ...
                            onChange={onChange}
                        />
                        <label className="uppercase text-black block text-lx font-bold">Imagen de Categoria</label>
                        <input 
                            type="text"
                            id="imagen"
                            name="imagen"
